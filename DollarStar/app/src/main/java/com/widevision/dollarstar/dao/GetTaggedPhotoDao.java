 ...
 */
public class GetTaggedPhotoDao extends QueryManager<PostGsonClass> {

    String user_id;

    public GetTaggedPhotoDao(String user_id) {

        this.user_id = user_id;
/* tag: get_mytagged_post
(user_id)*/
    }
