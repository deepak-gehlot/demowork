 ...
 */
public class SetFollowerDao extends QueryManager<GsonClass> {

    String user_id, following_id;

    public SetFollowerDao(String user_id, String following_id) {
