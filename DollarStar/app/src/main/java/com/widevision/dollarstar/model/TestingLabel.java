...
/**
 * Created by mercury-five on 27/07/16.
 */
public class TestingLabel extends AutoViewGroup implements Label.OnClickCrossListener, Label.OnLabelClickListener {

    private static final String LOG_TAG = TestingLabel.class.getSimpleName();
     ...
     * Default constructor
     */
    public TestingLabel(Context context) {
        this(context, null);
    }
     ...
     * Default constructor
     */
    public TestingLabel(Context context, AttributeSet attrs) {
     ...
     * Default constructor
     */
    public TestingLabel(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void getAttributes(AttributeSet attrs) {
        TypedArray typedArray = mContext
                .obtainStyledAttributes(attrs, com.dpizarro.autolabeluilibrary.R.styleable.LabelsView, 0, 0);

        if (typedArray != null) {
            try {
                mTextSize = typedArray.getDimensionPixelSize(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_text_size,
                        getResources().getDimensionPixelSize(com.dpizarro.autolabeluilibrary.R.dimen.label_title_size));
                mTextColor = typedArray.getColor(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_text_color,
                        getResources().getColor(android.R.color.white));
                mBackgroundResource = typedArray.getResourceId(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_label_background_res,
                        com.dpizarro.autolabeluilibrary.R.color.default_background_label);
                mMaxLabels = typedArray.getInteger(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_max_labels,
                        AutoLabelUISettings.DEFAULT_MAX_LABELS);
                mShowCross = typedArray.getBoolean(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_show_cross,
                        AutoLabelUISettings.DEFAULT_SHOW_CROSS);
                mIconCross = typedArray.getResourceId(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_icon_cross,
                        AutoLabelUISettings.DEFAULT_ICON_CROSS);
                mLabelsClickables = typedArray.getBoolean(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_label_clickable,
                        AutoLabelUISettings.DEFAULT_LABELS_CLICKABLES);
                mLabelPadding = typedArray.getDimensionPixelSize(com.dpizarro.autolabeluilibrary.R.styleable.LabelsView_label_padding,
                        getResources().getDimensionPixelSize(com.dpizarro.autolabeluilibrary.R.dimen.padding_label_view));
     ...
     * @param textLabel is the text of the label added.
     */
    public boolean addLabel(String textLabel, Object object) {
        if (!checkLabelsCompleted()) {
            Label label = new Label(getContext(), mTextSize, mIconCross, mShowCross,
                    mTextColor, mBackgroundResource, mLabelsClickables, mLabelPadding);
            label.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    public void onClickCross(View view) {
        ...
        if (listenerOnRemoveLabel != null) {
            if (view.getTag() instanceof Object) {
                listenerOnRemoveLabel.onRemoveLabel(view, (Object) view.getTag());
            } else {
    ...
    public interface OnRemoveLabelListener {
        ...
        void onRemoveLabel(View view, Object position);
    }
